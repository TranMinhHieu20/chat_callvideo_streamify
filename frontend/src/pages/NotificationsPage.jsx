...
import { friendAccept, getFriendRequests } from '../lib/api'
import { BellIcon, Clock1Icon, MessagesSquareIcon, UserCheckIcon } from 'lucide-react'
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto max-w-4xl space-y-8">
        <h1 className="sm:text-3xl text-2xl tracking-tight font-bold mb-6">Notifications</h1>
        {isLoading ? (
                          ...
                          <div className="flex justify-between flex-1">
                            <div>
                              ...
                              <p className="text-xs flex items-center opacity-70">
                                <Clock1Icon className="h-3 w-3 mr-1" />
                                Recently
                              </p>
                            </div>
